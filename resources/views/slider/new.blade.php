...
@section('content')
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="{{ route('customers.index')}}">Sliders</a></li>
      ...
      <section class="content">
        ...
        <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                      <form class="form-horizontal col-md-6" role="form" method="POST" action="{{ route('backend.slider.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
