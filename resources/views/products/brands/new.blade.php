...
@section('content')
      ...
      <section class="content">
        ...
        <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                      <form class="form-horizontal col-md-6" role="form" method="POST" action="{{ route('brands.store', $category->slug) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
                          <input id="product_id" type="hidden" class="form-control" name="product_id" value="{{ $category->id }}" >
                          <input id="title" type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Brand Title" required autofocus>
                          @if ($errors->has('title'))
