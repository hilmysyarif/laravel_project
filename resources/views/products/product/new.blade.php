...
@section('content')
      ...
      <section class="content">
        ...
        <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                      <form class="form-horizontal col-md-6" role="form" method="POST" action="{{ route('products.store', [$category->slug, $brand->id]) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
                          <input id="category_id" type="hidden" class="form-control" name="category_id" value="{{ $category->slug }}" >
                          <input id="brands_id" type="hidden" class="form-control" name="brands_id" value="{{ $brand->id }}" >
                          <input id="title" type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Product Title" required autofocus>
                          @if ($errors->has('title'))
